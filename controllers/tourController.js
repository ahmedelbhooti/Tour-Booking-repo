...
//Get Tours which is near to your start location
//Depending on the distance you provide and latitude and longitude
...
exports.getToursWithin = catchAsync(async (req, res, next) => {
  ...
  if (!lat || !lng)
    return next(new AppError('Please provide a latitude and longitude', 400));
