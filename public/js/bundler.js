...
var showAlert = exports.showAlert = function showAlert(type, mgs) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(mgs, "</div>");
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"forgetpassword.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', "Check your Dm for ".concat(email));
          }
          console.log(res);
          _context.next = 11;
          break;
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWhtZWRlbGJob290aSIsImEiOiJjbG40aHZ0emIwMG5sMmlwOWg3Znl1bm1lIn0.8Y6rH6uVeazHxWZSQrJ2uA';
...
//Type for password and data for email and name
...
var resetPassword = exports.resetPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(token, password, passwordConfirmation) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /*eslint-disable*/
var stripe = Stripe('pk_test_51NxbP0G5OMcQGF6QZmwTfiIVVHwRMH6sVtcEhQWWsaBafjIwDxlvnmHsPVhaF17O2dIj6qMjoXYIHL5mbiwvCIF500oNy5kWFA');
...
var update = document.querySelector('.form-user-data');
...
if (singUpForm) {
  singUpForm.addEventListener('submit', function (e) {
    ...
    form.append('passwordConfirmation', document.getElementById('password-confirm').value);
    // form.append('photo', document.getElementById('photo').files[0]);

    (0, _signup.signUp)(form);
  });
}
if (loginForm) {
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _resetpassword.resetPassword)(token, password, passwordConfirmation);
  });
}
if (bookTourBtn) {
